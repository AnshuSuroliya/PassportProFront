...
<div className="bg-gradient-to-br from-zinc-200 to-zinc-100 w-full py-1">
  ...
  <div class="flex items-center ">
            ...
            <input name="email" maxLength="24" className="appearance-none bg-transparent  border-b border-teal-500 py-2 focus:border-b-2 w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none outline-blue-500" required type="email" placeholder="Email"  onChange={handleChange3}/>
                </div>
