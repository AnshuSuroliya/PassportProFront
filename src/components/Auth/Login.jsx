...
const Login=()=>{
  ...
  <div class="flex items-center">
            ...
            <input name="email" required  className="appearance-none bg-transparent border-b border-teal-500 py-2 focus:border-b-2 w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none outline-blue-500 text-center" type="email" placeholder="Email" onChange={checkValidation}/>
