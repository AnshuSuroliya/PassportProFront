...
const Footer=()=>{
    return(
        <div className="w-full px-3 py-10 bg-[#1e1e1e]">
            
            <div className="grid grid-cols-1 gap-x-24 sm:grid-cols-2 lg:grid-cols-4 sm:gap-y-44">
                ...
                <div className="w-32 h-32">
                    <h2 className="mb-3 font-bold text-stone-400 text-xl">Legal Information</h2>

                    <div><Link className="text-white hover:underline" to="/privacy">Privacy Policy</Link></div>
                    <div><Link className="text-white hover:underline" to="/copyright">Copyright Policy</Link></div>
                    <div><Link className="text-white hover:underline" to="/hyperlinking">Hyperlinking Policy</Link></div>
                ...
                <div className="w-24 h-32">
                    ...
                    <div><Link className="text-white hover:underline" to="/faq">FAQs</Link></div>
